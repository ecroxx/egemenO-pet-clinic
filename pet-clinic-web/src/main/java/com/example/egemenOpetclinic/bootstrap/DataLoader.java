package com.example.egemenOpetclinic.bootstrap;
...
import com.example.egemenOpetclinic.services.map.OwnerServiceMap;
import com.example.egemenOpetclinic.services.map.VetServiceMap;
